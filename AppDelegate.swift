...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication!, didFinishLaunchingWithOptions launchOptions: NSDictionary!) -> Bool {
        ...
        // Un-Rem the next 3 lines to delete all NSUserDefault settings for this app and then quickly terminate
...
//        return false
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        // println("Location of sqlite file: \(url)")
        ...
        if coordinator!.addPersistentStoreWithType(NSSQLiteStoreType, configuration: nil, URL: url, options: nil, error: &error) == nil {
            ...
            error = NSError.init(domain:"YOUR_ERROR_DOMAIN", code: 9999, userInfo: dict)
